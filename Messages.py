...
m_is_not_free_users = 'Üzgünüz ama şu anda müsait kullanıcı yok.\nMüsait bir kullanıcı olduğunda otomatik olarak bağlanacaksınız!'
m_is_connect = 'Bir üyeye bağlandınız! Mesaj yazarak onu selamlayın.'
...
m_dislike_user = 'Karşı taraf ile sohbet sonlandırıldı!'

m_dislike_user_to = 'Karşı taraf sizinle sohbeti sonlandırdı üzgünüm.'

m_send_some_messages = 'Kendi mesajlarınızı iletemezsiniz'

m_has_not_dialog = 'Kimseyle bağlı değilsin!'

dislike_str = 'Sohbeti Sonlandır!'
